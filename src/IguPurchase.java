...
public class IguPurchase {
	...
	private JTextField unitP;
	private JTextField Amt;
	private JTextField TlAmt;
	...
	public IguPurchase(String PatId) {
		try
		{
			patNumber=PatId;
		...
		JLabel lblNewLabel = new JLabel("IGU Patients Medicine Purchase");
		...
		medQuant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				unit=Integer.parseInt(unitP.getText());
				amt=quantity*unit;
				Amt.setText(String.format("%s",amt));
				try
				{
				...
				TlAmt.setText(String.format("%s",total));
				}
				catch(SQLException ex)
				{
					JOptionPane.showMessageDialog(null,ex);
		...
		JLabel lblNewLabel_10 = new JLabel("Unit Price");
		lblNewLabel_10.setBounds(10, 159, 82, 25);
		panel_1.add(lblNewLabel_10);
		
		unitP = new JTextField();
		unitP.setBounds(129, 161, 127, 20);
		panel_1.add(unitP);
		unitP.setColumns(10);
		...
		panel_2.setBounds(10, 269, 312, 67);
		frame.getContentPane().add(panel_2);
		panel_2.setLayout(null);
		
		JLabel lblNewLabel_12 = new JLabel("Amount");
		lblNewLabel_12.setBounds(0, 11, 75, 20);
		panel_2.add(lblNewLabel_12);
		
		Amt = new JTextField();
		Amt.setBounds(108, 11, 97, 20);
		panel_2.add(Amt);
		Amt.setColumns(10);
		
		JLabel lblNewLabel_13 = new JLabel("Total Amount");
		lblNewLabel_13.setBounds(0, 38, 75, 20);
		panel_2.add(lblNewLabel_13);
		
		TlAmt = new JTextField();
		TlAmt.setBounds(108, 42, 97, 20);
		panel_2.add(TlAmt);
		TlAmt.setColumns(10);
		
		JLabel lblNewLabel_11 = new JLabel("Price Details");
		lblNewLabel_11.setBounds(10, 240, 108, 25);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try
				{
					...
					unity=Integer.parseInt(unitP.getText());
					amount=Integer.parseInt(Amt.getText());
					
					
					SQL iguPat=new SQL();
					iguPat.iguPatient(pnum, pname, medname, medtype, mednum,medQuan,unity,amount, date);
